...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <!--&nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp-->
 ...
 <a href="index.php"><h2><span>Conestoga</span><span>Student</span><span>Employment</span><span>Guide</span></h2></a>
      ...
      <div class="inside">
			...
			<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="loginform">
				<fieldset>
					<h2>Log<span>in</span></h2>
						<h4>Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
						<input type="text" name="email" placeholder="Your Email" /></h4>
						<h4>Password&nbsp&nbsp
						<input type="password" name="password" placeholder="Your Password" /></h4>
			...
			<br>
		<i><strong>New User? </i></strong><a href="signregister.php">Sign Up Here</a>
