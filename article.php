...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <!--&nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp-->
 ...
 <a href="index.php"><h2><span>Conestoga</span><span>Student</span><span>Employment</span><span>Guide</span></h2></a>
      ...
      <div class="inside">
	  <h2><span>ARTI</span>CLES</h2>
	  <br><br>
        <a href="self_assessment.php"><h2><img src="images/icon4.png"/>Self <span>-Assessment</span></h2></a><br>
		<a href="occupational_research.php"><h2><img src="images/icon4.png"/>Occupational<span> Research</span></h2></a><br>
		<a href="labour_market_trends.php"><h2><img src="images/icon4.png"/>Labour Market<span> Trends</span></h2></a><br>
		<a href="uncovering_your_network.php"><h2><img src="images/icon4.png"/>Uncovering Your <span>Network</span></h2></a><br>
		<a href="developing_your_brand.php"><h2><img src="images/icon4.png"/>Developing Your <span>Brand</span></h2></a><br>
		<a href="job_search_tools.php"><h2><img src="images/icon4.png"/>Job Search <span>Tools</span></h2></a><br>
		<a href="job_search_strategy.php"><h2><img src="images/icon4.png"/>Job Search <span>Strategy</span></h2></a><br>
